...
from Prism_Draw_fun_obj import *
from find_intersection import intersection, line, intersectionobj, angles, snell, makeline

# define prisms parameters:
prismA = Prism(n=1.55, t1=m.radians(50), t2=m.radians(50), height=120, base=250)
side_ab = line(prismA.p_a, prismA.p_b)  # side a of the prism
side_ad = line(prismA.p_a, prismA.p_d)  # side d of the prism

# prismA.plot_prism()  # plot prism
sub_h=340
...
prismB = Prism(n=1.55, t1=m.radians(50), t2=m.pi/2-l_4_t, height=120, base=l_3p2[0]-side_ab.p2[0])
prismB.plot_prism()
